...
export default function SearchSideBar({ locations, cuisines, searchParams }: Readonly<{ locations: Location[], cuisines: Cuisine[], searchParams: { city?: string, cuisine?: string, price?: PRICE } }>) {
